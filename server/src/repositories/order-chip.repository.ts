...
export class OrderChipRepository extends DefaultCrudRepository<
  ...
  OrderChipRelations
> {
  public readonly fileInfo: BelongsToAccessor<
    FileInfo,
    typeof OrderChip.prototype.id
  >;

  public readonly worker: BelongsToAccessor<
    FoundryWorker,
    typeof OrderChip.prototype.id
  >;
  ...
  constructor(
    ...
    this.worker = this.createBelongsToAccessorFor(
      'worker',
      foundryWorkerRepositoryGetter,
    );
    this.registerInclusionResolver('worker', this.worker.inclusionResolver);
    this.fileInfo = this.createBelongsToAccessorFor(
      'fileInfo',
