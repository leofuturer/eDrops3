...
export class UserUserController {
  ...
  @get('/users/{id}/users', {
    responses: {
      '200': {
        description: 'Array of User has many User through UserFollower',
        content: {
          'application/json': {
  ...
  async create(
    ...
    return this.userRepository.followers(id).create(user);
  }
  ...
  async patch(
    ...
    return this.userRepository.followers(id).patch(user, where);
  }
