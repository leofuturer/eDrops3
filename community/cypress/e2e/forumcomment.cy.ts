...
describe('Forum comment tests', () => {
    ...
    it("Post a comment", () => {
        cy.intercept('POST', '/api/posts/*/post-comments').as('response');
    ...
    it("Edit a comment", () => {
        cy.intercept('PATCH', '/api/post-comments/*/post-comments').as("response");
    ...
    it("Delete a comment", () => {
        cy.intercept('DELETE', '/api/post-comments/*/post-comments').as("response");
