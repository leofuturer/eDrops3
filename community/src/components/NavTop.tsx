...
export function NavTop() {
  ...
  useEffect(() => {
	...
	return (
		<div className="">
			<header className="flex flex-row items-center h-[80px] w-full text-white px-32 justify-between bg-primary">
				<div id="navLeft" className="flex flex-row items-center py-4 h-full space-x-8 text-xl lg:text-2xl font-medium">
					<NavLink
						to="/"
				...
				<div id="navRight"className="flex flex-row items-center justify-center space-x-8  text-xl lg:text-2xl font-medium">
					{notLoggedIn ? (
						<>
							<NavLink to="/login">
