...
function UserMenu({ username, onSignout }: { username: string, onSignout: () => void }) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      {({ open }) => <>
        <div>
          <Menu.Button className="inline-flex justify-center items-center space-x-2 w-full pl-4 pr-2 py-2 text-base font-medium text-black bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
