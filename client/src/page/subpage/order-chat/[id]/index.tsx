        ...
        {Object.keys(filteredMessages).sort((a, b) => parseInt(a) - parseInt(b)).map((time, i) =>
          <>
            ...
            {filteredMessages[parseInt(time)].map((msg, j) =>
              <ChatMessage key={parseInt(time) + j} msg={msg} cookies={cookies} displayName={customerName}/>
            )}
          </>
        )}
      </div>
...
function ChatMessage({ msg, cookies, displayName }: { msg: DTO<OrderMessage>, cookies: any, displayName: string }) {
