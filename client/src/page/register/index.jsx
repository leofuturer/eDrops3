                            ...
                            <div className="input-content-register">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6 text-left">
                                        <input id="inputEmail" type="email" name="email" autoComplete="email"
                                               className="form-control needValidation" placeholder="Email" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6">
                                        <input type="text" id="inputUsername" name="username" autoComplete="username"
                                               className="form-control needValidation" placeholder="Username"
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6 text-left">
                                        <input type="password" name="password" className="form-control needValidation" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6 text-left">
                                        <input type="password" name="confirmPassword" className="form-control needValidation" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6">
                                        <input type="text" className="form-control needValidation" name="firstName" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6">
                                        <input type="text" className="form-control needValidation" name="lastName" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6 text-left">
                                        ...
                                        <input type="text" name="phoneNumber" className="form-control needValidation" 
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6 text-left">
                                        <input type="text" className="form-control" 
                                               placeholder="Street Line 2 (optional)" autoComplete="address-line2"
