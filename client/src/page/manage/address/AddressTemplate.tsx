...
function AddressTemplate({ address, handleDelete, handleSetDefault}: { address: DTO<Address>, handleDelete: () => void, handleSetDefault: () => void }) {
  return (
    <div className="flex flex-col bg-white rounded-md shadow-lg shadow-primary-light/25 border-primary-light/25 border-[1px]  text-sm ">
      ...
      <hr className="border-primary-light/25" />
