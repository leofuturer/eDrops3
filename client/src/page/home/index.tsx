        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-4 xl:gap-10 w-3/4 xl:w-2/3">
          <NavLink to={idRoute(ROUTES.Product, controlSysId)} className="flex flex-col">
            <figure className="scale-90 hover:scale-100 duration-500 ease-in-out">
              <img src="/img/control-system.webp" alt="Digital microfluidics control system picture" className="pointer-events-none aspect-auto" />
            </figure>
          ...
          <NavLink to={idRoute(ROUTES.Product, pcbChipId)} className="flex flex-col">
            <figure className="scale-90 hover:scale-100 duration-500 ease-in-out">
              <img src="/img/pcb_chip.webp" alt="PCB-based digital microfluidics chip picture" className="pointer-events-none aspect-auto" />
            </figure>
          ...
          <NavLink to={idRoute(ROUTES.Product, testBoardId)} className="flex flex-col">
            <figure className="scale-90 hover:scale-100 duration-500 ease-in-out">
              <img src="/img/inspection_board.webp" alt="Control system inspection board picture" className="pointer-events-none aspect-auto" />
            </figure>
