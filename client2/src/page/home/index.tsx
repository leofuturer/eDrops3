    ...
    <div className="flex flex-col space-y-16 mb-16">
      ...
      <div className="grid grid-cols-3 text-black">
        <div className="bg-[url('/img/EWOD-CAD.png')] bg-cover bg-no-repeat bg-center flex flex-col space-y-4 justify-center items-center w-full aspect-[4/3]" >
          <h1 className="text-7xl font-bold text-center">DMF<br />CAD</h1>
          <a href="http://cad.edrops.org" target="_blank" rel="noopener noreferrer" className="py-6 px-10 bg-accent w-max text-2xl font-semibold">
            DESIGN CHIP
          </a>
        </div>
        <div className="bg-[url('/img/EWOD-chip-compressed.png')] bg-cover bg-no-repeat bg-center flex flex-col space-y-4 justify-center items-center w-full aspect-[4/3]">
          <h1 className="text-7xl font-bold text-center">Foundry<br />Service</h1>
          {
            cookies.userType === 'customer'
              ? <NavLink to="/upload" className="py-6 px-10 bg-accent w-max text-2xl font-semibold">UPLOAD MASK FILE</NavLink>
              : <NavLink to="/login" className="py-6 px-10 bg-accent w-max text-2xl font-semibold">UPLOAD MASK FILE</NavLink>
          }
        </div>
        <div className="bg-[url('/img/control-system-compressed.png')] bg-cover bg-no-repeat bg-center flex flex-col space-y-4 justify-center items-center w-full aspect-[4/3]">
          <h1 className="text-7xl font-bold text-center">DMF<br />Control System</h1>
          <NavLink to={controlSysPageLink} className="py-6 px-10 bg-accent w-max text-2xl font-semibold">VIEW DETAILS</NavLink>
        </div>
      </div>

      <div className="flex flex-col space-y-10 items-center">
        <NavLink to="/allItems" className="border-b-2 border-secondary w-1/4 text-center py-4">
          <h1 className="text-secondary text-6xl">Products</h1>
        </NavLink>
        <div className="grid grid-cols-3 gap-10 w-2/3">
          <NavLink to={controlSysPageLink} className="flex flex-col">
            ...
            <h4 className="text-primary_light text-3xl border-t-2 py-8 text-center">Digital Microfluidics Control System</h4>
          </NavLink>
          <NavLink to={pcbChipPageLink} className="flex flex-col">
            ...
            <h4 className="text-primary_light text-3xl border-t-2 py-8 text-center">PCB-based Digital Microfluidics Chip</h4>
          </NavLink>
          <NavLink to={testBoardPageLink} className="flex flex-col">
            ...
            <h4 className="text-primary_light text-3xl border-t-2 py-8 text-center">Control System Inspection Board</h4>
          </NavLink>
        </div>
      </div>
    </div >
