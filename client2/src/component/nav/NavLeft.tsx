    ...
    <div className="flex flex-col items-center space-y-8 py-8">
      ...
      <div className="flex flex-col space-y-4 text-3xl">
        ...
        <AuthNavLeftLink to="/manage/files" userTypes={['customer']}>
          <i className="fa fa-database w-10 aspect-square" />
